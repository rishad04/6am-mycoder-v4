...
class SubscriptionPlanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.subscription-plans.create', compact('page_title', 'info'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.subscription-plans.show', compact('page_title', 'info', 'data'))->with('id', $id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.subscription-plans.edit', compact('page_title', 'info', 'data'))->with('id', $id);
    }
