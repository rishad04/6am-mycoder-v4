...
class ProductCategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product-categories.create', compact('page_title', 'info'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.product-categories.show', compact('page_title', 'info', 'data'))->with('id', $id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.product-categories.edit', compact('page_title', 'info', 'data'))->with('id', $id);
    }
