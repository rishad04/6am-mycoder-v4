...
class SubscriptionUserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.subscription-users.create', compact('page_title', 'info'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.subscription-users.show', compact('page_title', 'info', 'data'))->with('id', $id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.subscription-users.edit', compact('page_title', 'info', 'data'))->with('id', $id);
    }
