...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.products.create', compact('page_title', 'info'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.products.show', compact('page_title', 'info', 'data'))->with('id', $id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.products.edit', compact('page_title', 'info', 'data'))->with('id', $id);
    }
