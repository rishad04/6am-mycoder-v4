...
class SubscriptionPlanSeeder extends Seeder
{
    ...
    public function run()
    {
        $plans = [
            [
                'title'         => 'Basic',
                'banner'        => 'backend/assets/images/plans/basic_plan.png',
            ...
            [
                'title'         => 'Standard',
                'banner'        => 'backend/assets/images/plans/standard_plan.png',
            ...
            [
                'title'         => 'Premium',
                'banner'        => 'backend/assets/images/plans/premium_plan.png',
